...
import com.ted.commander.client.view.dailyDetail.DailyDetailPresenter;


public class DailyDetailActivity extends AuthorizedActivity {


    public DailyDetailActivity(DailyDetailPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final DailyDetailPresenter presenter = new DailyDetailPresenter(clientFactory, (DailyDetailPlace) place);
