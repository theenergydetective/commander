...
import com.ted.commander.client.view.adviceEdit.AdviceEditPresenter;


public class AdviceEditActivity extends AuthorizedActivity {


    public AdviceEditActivity(AdviceEditPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final AdviceEditPresenter presenter = new AdviceEditPresenter(clientFactory, (AdviceEditPlace) place);
