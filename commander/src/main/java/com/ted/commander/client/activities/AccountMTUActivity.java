...
import com.ted.commander.client.presenter.AccountMTUPresenter;

public class AccountMTUActivity extends AuthorizedActivity {


    public AccountMTUActivity(AccountMTUPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final AccountMTUPresenter presenter = new AccountMTUPresenter(clientFactory, (AccountMTUPlace) place);
