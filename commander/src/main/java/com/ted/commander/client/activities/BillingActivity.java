...
import com.ted.commander.client.view.billing.BillingPresenter;


public class BillingActivity extends AuthorizedActivity {


    public BillingActivity(BillingPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final BillingPresenter presenter = new BillingPresenter(clientFactory, (BillingPlace) place);
