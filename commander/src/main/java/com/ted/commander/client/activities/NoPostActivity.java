...
import com.ted.commander.client.view.noPost.NoPostPresenter;


public class NoPostActivity extends AuthorizedActivity {


    public NoPostActivity(NoPostPlace place, ClientFactory clientFactory) {
        ...
        authorize(new SimpleCallback<Boolean>() {
            ...
            public void onCallback(Boolean value) {
                if (!value) {
                    ...
                    eventBus.fireEvent(new PlaceRequestEvent(new LoginPlace("nopost"), place, null));
                    return;
                }
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    @Override
                    public void onSuccess() {
                        final NoPostPresenter presenter = new NoPostPresenter(clientFactory, (NoPostPlace) place);
