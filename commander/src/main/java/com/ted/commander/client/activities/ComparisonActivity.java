...
import com.ted.commander.client.view.comparison.ComparisonPresenter;


public class ComparisonActivity extends AuthorizedActivity {


    public ComparisonActivity(ComparisonPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final ComparisonPresenter presenter = new ComparisonPresenter(clientFactory, (ComparisonPlace) place);
