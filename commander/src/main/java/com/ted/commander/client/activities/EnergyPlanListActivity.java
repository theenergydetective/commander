...
import com.ted.commander.client.view.energyPlanList.EnergyPlanListPresenter;


public class EnergyPlanListActivity extends AuthorizedActivity {


    public EnergyPlanListActivity(EnergyPlanListPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final EnergyPlanListPresenter presenter = new EnergyPlanListPresenter(clientFactory, (EnergyPlanListPlace) place);
