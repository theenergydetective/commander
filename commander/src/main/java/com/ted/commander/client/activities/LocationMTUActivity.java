...
import com.ted.commander.client.presenter.LocationMTUPresenter;

public class LocationMTUActivity extends AuthorizedActivity {


    public LocationMTUActivity(LocationMTUPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final LocationMTUPresenter presenter = new LocationMTUPresenter(clientFactory, (LocationMTUPlace) place);
