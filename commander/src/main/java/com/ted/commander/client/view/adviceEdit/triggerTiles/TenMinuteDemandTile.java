...
public class TenMinuteDemandTile extends Composite implements TriggerPanel {

    static final Logger LOGGER = Logger.getLogger(TenMinuteDemandTile.class.getName());
    ...
    public TenMinuteDemandTile(final AdviceTrigger adviceTrigger, final EnergyPlan energyPlan) {
    ...
    interface DefaultBinder extends UiBinder<Widget, TenMinuteDemandTile> {
    }
