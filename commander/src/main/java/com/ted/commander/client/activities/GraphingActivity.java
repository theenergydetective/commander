...
import com.ted.commander.client.view.graphing.GraphingPresenter;


public class GraphingActivity extends AuthorizedActivity {


    public GraphingActivity(GraphingPlace place, ClientFactory clientFactory) {
    ...
    public void start(final AcceptsOneWidget container, final EventBus eventBus) {
        ...
        authorize(new SimpleCallback<Boolean>() {
            ...
            public void onCallback(Boolean value) {
                LOGGER.info("STARTING GraphingActivity");
                if (!value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final GraphingPresenter presenter = new GraphingPresenter(clientFactory, (GraphingPlace) place);
