...
import com.ted.commander.client.view.adviceList.AdviceListPresenter;


public class AdviceListActivity extends AuthorizedActivity {


    public AdviceListActivity(AdviceListPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final AdviceListPresenter presenter = new AdviceListPresenter(clientFactory, (AdviceListPlace) place);
