...
public class TenMinuteConsumedTile extends Composite implements TriggerPanel {

    static final Logger LOGGER = Logger.getLogger(TenMinuteConsumedTile.class.getName());
    ...
    public TenMinuteConsumedTile(final AdviceTrigger adviceTrigger) {
    ...
    interface DefaultBinder extends UiBinder<Widget, TenMinuteConsumedTile> {
    }
