...
import com.ted.commander.client.view.graphing.GraphingOptionsPresenter;


public class GraphingOptionsActivity extends AuthorizedActivity {


    public GraphingOptionsActivity(GraphingOptionsPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final GraphingOptionsPresenter presenter = new GraphingOptionsPresenter(clientFactory, (GraphingOptionsPlace) place);
