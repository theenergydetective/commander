...
import com.ted.commander.client.view.locationList.LocationListPresenter;


public class LocationListActivity extends AuthorizedActivity {


    public LocationListActivity(LocationListPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final LocationListPresenter presenter = new LocationListPresenter(clientFactory, (LocationListPlace) place);
