...
import com.ted.commander.client.presenter.ActivationKeysPresenter;


public class ActivationKeysActivity extends AuthorizedActivity {


    public ActivationKeysActivity(ActivationKeysPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final ActivationKeysPresenter presenter = new ActivationKeysPresenter(clientFactory, (ActivationKeysPlace) place);
