...
import com.ted.commander.client.view.energyPlan.EnergyPlanPresenter;


public class EnergyPlanActivity extends AuthorizedActivity {


    public EnergyPlanActivity(EnergyPlanPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final EnergyPlanPresenter presenter = new EnergyPlanPresenter(clientFactory, (EnergyPlanPlace) place);
