...
import com.ted.commander.client.view.dashboard.DashboardPresenter;
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final DashboardPresenter presenter = new DashboardPresenter(clientFactory, (DashboardPlace) place);
