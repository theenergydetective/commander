...
public class VoltageExceedsTile extends Composite implements TriggerPanel {

    static final Logger LOGGER = Logger.getLogger(VoltageExceedsTile.class.getName());
    ...
    public VoltageExceedsTile(final AdviceTrigger adviceTrigger, final EnergyPlan energyPlan) {
    ...
    interface DefaultBinder extends UiBinder<Widget, VoltageExceedsTile> {
    }
