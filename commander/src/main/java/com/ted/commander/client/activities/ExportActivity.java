...
import com.ted.commander.client.view.export.ExportPresenter;


public class ExportActivity extends AuthorizedActivity {


    public ExportActivity(ExportPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final ExportPresenter presenter = new ExportPresenter(clientFactory, (ExportPlace) place);
