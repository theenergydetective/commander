...
import com.ted.commander.client.view.userSettings.ChangeEmailPresenter;


public class ChangeEmailActivity extends AuthorizedActivity {


    public ChangeEmailActivity(ChangeEmailPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final ChangeEmailPresenter presenter = new ChangeEmailPresenter(clientFactory, (ChangeEmailPlace) place);
