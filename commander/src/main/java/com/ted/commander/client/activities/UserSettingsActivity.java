...
import com.ted.commander.client.view.userSettings.UserSettingsPresenter;


public class UserSettingsActivity extends AuthorizedActivity {


    public UserSettingsActivity(UserSettingsPlace place, ClientFactory clientFactory) {
            ...
            public void onCallback(Boolean value) {
                ...
                GWT.runAsync(new DefaultRunAsyncCallback() {
                    ...
                    public void onSuccess() {
                        final UserSettingsPresenter presenter = new UserSettingsPresenter(clientFactory, (UserSettingsPlace) place);
