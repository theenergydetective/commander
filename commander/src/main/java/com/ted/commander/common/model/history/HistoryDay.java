...
public class HistoryDay implements History, HistoryNetGenLoad, HistoryTOU, HistoryVoltage, HistoryPowerFactor, HistoryDemandPeak, HistoryCost, Serializable {
    ...
    HistoryDayKey key = new HistoryDayKey();

    public HistoryDayKey getKey() {
        return key;
    }

    public void setKey(HistoryDayKey key) {
        this.key = key;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (generationPeakTime != null ? !generationPeakTime.equals(that.generationPeakTime) : that.generationPeakTime != null)
            return false;
        return generationPeakCalendarKey != null ? generationPeakCalendarKey.equals(that.generationPeakCalendarKey) : that.generationPeakCalendarKey == null;
